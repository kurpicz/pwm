...
struct wx_dd_fe_registry {
  ...
  using wt_dd_pc_fe1 = wx_dd_pc_fe<uint8_t, true, bytesMemory, false>;
  using wt_dd_pc_fe2 = wx_dd_pc_fe<uint8_t, true, bytesMemory, true>;

  using wm_dd_pc_fe1 = wx_dd_pc_fe<uint8_t, false, bytesMemory, false>;
  using wm_dd_pc_fe2 = wx_dd_pc_fe<uint8_t, false, bytesMemory, true>;
