...
CONSTRUCTION_REGISTER("wm_ps_fe_wp0",
  "Sequential wavelet matrix construction with 8-bit alphabet (using sorting, fully external, no wordpacking).",
  wm_ps_8_fe_wp0)
CONSTRUCTION_REGISTER("wt_ps_fe_wp0",
  "Sequential wavelet tree construction with 8-bit alphabet (using sorting, fully external, no wordpacking).",
  wt_ps_8_fe_wp0)
CONSTRUCTION_REGISTER("wm_ps_fe_wp1",
  "Sequential wavelet matrix construction with 8-bit alphabet (using sorting, fully external, wordpacking with padding).",
  wm_ps_8_fe_wp1)
CONSTRUCTION_REGISTER("wt_ps_fe_wp1",
  "Sequential wavelet tree construction with 8-bit alphabet (using sorting, fully external, wordpacking with padding).",
  wt_ps_8_fe_wp1)
CONSTRUCTION_REGISTER("wm_ps_fe_wp2",
  "Sequential wavelet matrix construction with 8-bit alphabet (using sorting, fully external, wordpacking without padding).",
  wm_ps_8_fe_wp2)
CONSTRUCTION_REGISTER("wt_ps_fe_wp2",
  "Sequential wavelet tree construction with 8-bit alphabet (using sorting, fully external, wordpacking without padding).",
  wt_ps_8_fe_wp2)
