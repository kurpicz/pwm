...
using wm_ppc_ss_8 = wx_ppc_ss<uint8_t, true>;
using wm_ppc_ss_16 = wx_ppc_ss<uint16_t, true>;
using wm_ppc_ss_32 = wx_ppc_ss<uint32_t, true>;
...
using wt_ppc_ss_8 = wx_ppc_ss<uint8_t, false>;
using wt_ppc_ss_16 = wx_ppc_ss<uint16_t, false>;
using wt_ppc_ss_32 = wx_ppc_ss<uint32_t, false>;
