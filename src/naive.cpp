...
using wm_huff_naive_16 = wx_huff_naive<uint16_t, true>;
using wm_huff_naive_32 = wx_huff_naive<uint32_t, true>;
CONSTRUCTION_REGISTER("huff_wm_naive",
...
using wt_huff_naive_16 = wx_huff_naive<uint16_t, false>;
using wt_huff_naive_32 = wx_huff_naive<uint32_t, false>;
CONSTRUCTION_REGISTER("huff_wt_naive",
