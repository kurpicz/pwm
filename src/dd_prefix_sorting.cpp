...
using wm_dd_ps_8 = wx_dd_ps<uint8_t, false, memory_mode::internal>;
using wm_dd_ps_16 = wx_dd_ps<uint16_t, false, memory_mode::internal>;
using wm_dd_ps_32 = wx_dd_ps<uint32_t, false, memory_mode::internal>;
...
using wt_dd_ps_8 = wx_dd_ps<uint8_t, true, memory_mode::internal>;
using wt_dd_ps_16 = wx_dd_ps<uint16_t, true, memory_mode::internal>;
using wt_dd_ps_32 = wx_dd_ps<uint32_t, true, memory_mode::internal>;
