...
using wm_dd_ps_8 = wx_dd_ps<uint8_t, false>;
using wm_dd_ps_16 = wx_dd_ps<uint16_t, false>;
using wm_dd_ps_32 = wx_dd_ps<uint32_t, false>;
...
using wt_dd_ps_32 = wx_dd_ps<uint32_t, true>;
