...
public:
  ...
  virtual float median_time(const void* global_text,
                            const uint64_t size,
                            const uint64_t levels,
                            const uint64_t runs) const = 0;
  virtual void memory_peak(const void* global_text,
                           const uint64_t size,
                           const uint64_t levels) const = 0;
...
public:
  ...
  inline wavelet_structure
  compute_bitvector(const void* global_text,
                    const uint64_t size,
  ...
  float median_time(const void* global_text,
                    const uint64_t size,
                    const uint64_t levels,
                    const uint64_t runs) const override {
